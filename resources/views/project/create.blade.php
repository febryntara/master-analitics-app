                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                {{ __('Insert new project data for new group of analysis') }}
                            </p>
                        </header>
                        ...
                        <form method="post" action="{{ route('projects.store') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="description" name="description" type="text"
                                    class="mt-1 block w-full" :value="old('description')" autofocus autocomplete="description" />
                            ...
                            <div>
                                ...
                                <x-text-input id="raw_text_label" name="raw_text_label" type="text"
                                    class="mt-1 block w-full" :value="old('raw_text_label')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="raw_id_label" name="raw_id_label" type="text"
                                    class="mt-1 block w-full" :value="old('raw_id_label')" required autofocus
